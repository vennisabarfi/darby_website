    ...
    return(
        ...
        <div className="resume-headshot">
            ...
            <div className="resume">
                ...
                <Button  className="resume-link" variant="link"><a href="/resume" target="_blank">View Full Resume</a> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5">
